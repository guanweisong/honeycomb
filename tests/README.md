...
最近一次全量单元测试在当前工作树上执行：252 个测试文件通过、0 个测试文件跳过，1140 个测试通过、0 个 TODO。进程级门禁另有 2 个测试文件、52 项测试通过。

| 指标 | 基线 | 通过全局门槛还需覆盖 |
| --- | ---: | ---: |
 | Statements | 82.03%（3914/4771） | 已超过 70% |
 | Lines | 83.09%（3681/4430） | 已超过 70% |
 | Functions | 80.25%（1260/1570） | 已超过 65% |
 | Branches | 74.66%（2210/2960） | 已超过 60% |
