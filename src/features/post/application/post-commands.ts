...
/** 更新文章。 */
export function updatePost(repository: Pick<PostCommandRepository, "findStatus" | "update">, input: PostUpdateCommand) { return updatePostThroughAggregate(repository, input); }
/** 替换文章标签关联。 */
