...
export type PostCommandInput = Partial<Omit<Pick<PostInsertValues, "title" | "content" | "excerpt" | "status" | "type" | "categoryId" | "coverId" | "commentStatus" | "quoteAuthor" | "quoteContent" | "movieTime" | "galleryLocation" | "galleryTime">, "title" | "content" | "excerpt" | "quoteAuthor" | "quoteContent" | "galleryLocation">> & { title?: unknown; content?: unknown; excerpt?: unknown; quoteAuthor?: unknown; quoteContent?: unknown; galleryLocation?: unknown; categoryId?: string };
