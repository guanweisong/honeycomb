import "server-only";
import type { CommentTarget, CommentTargetRepository } from "../infrastructure/comment-target-repository";
export type { CommentTarget } from "../infrastructure/comment-target-repository";
