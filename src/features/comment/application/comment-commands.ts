...
import type { CommentCommandRepository, CommentUpdate, PublicCommentInput } from "../infrastructure/comment-command-repository";
export type { CommentUpdate, PublicCommentInput } from "../infrastructure/comment-command-repository";
