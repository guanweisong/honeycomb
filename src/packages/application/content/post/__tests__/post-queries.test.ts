...
import * as filters from "@/packages/application/content/post/post-filters";
import * as relations from "@/packages/application/content/post/post-relations";
import { TEST_IDS } from "@tests/helpers/test-constants";
import { createMockDb, resetMockDb } from "@tests/helpers/test-utils";

const mockDb = createMockDb();

let getPostList: typeof import("@/packages/application/content/post/post-queries").getPostList;
...
describe("getPostList", () => {
  beforeEach(async () => {
    ...
    ({ getPostList } =
      await import("@/packages/application/content/post/post-queries"));
  });
