...
describe('Tag Router', () => {
  ...
  describe('index procedure', () => {
    it('should return tag list with pagination', async () => {
      const mockTags = [
        { id: TEST_IDS.ID_1, name: { en: 'Tag 1', zh: '标签1' }, createdAt: new Date() },
        { id: TEST_IDS.ID_2, name: { en: 'Tag 2', zh: '标签2' }, createdAt: new Date() },
      ]
  ...
  describe('create procedure', () => {
    it('should create tag with admin permissions', async () => {
      const newTag = { id: TEST_IDS.ID_3, name: { en: 'New Tag', zh: '新标签' } }
  ...
  describe('update procedure', () => {
    it('should update tag with admin permissions', async () => {
      const updatedTag = { id: TEST_IDS.ID_1, name: { en: 'Updated Tag', zh: '更新的标签' } }
