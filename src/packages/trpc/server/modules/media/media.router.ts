...
import { MediaListQuerySchema } from "@/packages/trpc/server/modules/media/schemas/media.list.query.schema";
...
import { MediaInsertSchema } from "@/packages/trpc/server/modules/media/schemas/media.insert.schema";
